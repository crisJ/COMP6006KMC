...
24/04 14:05:52 FINE aw.DummyAgent|price number 8 : 12 
24/04 14:05:52 FINE aw.DummyAgent|price number 9 : 13 
24/04 14:05:52 FINE aw.DummyAgent|price number 10 : 14 
24/04 14:05:52 FINE aw.DummyAgent|price number 11 : 15 
24/04 14:05:52 FINE aw.DummyAgent|price number 12 : 8 
24/04 14:05:52 FINE aw.DummyAgent|price number 13 : 9 
24/04 14:05:52 FINE aw.DummyAgent|price number 14 : 10 
24/04 14:05:52 FINE aw.DummyAgent|price number 15 : 11 
...
public class CopyOfDummyAgent extends AgentImpl {
	
  private static final Logger log =
    Logger.getLogger(CopyOfDummyAgent.class.getName());
...
//method to edit
  public void quoteUpdated(Quote quote) {
	  ...
	  log.fine("auction number: " + quote.getAuction() + " price: " + quote.getAskPrice());
	  ...
	  for (int i = 0; i < 28; i++) {
		  ...
		  information[i] = agent.getAuctionFor(TACAgent.CAT_FLIGHT,
			  ...
			  information[i] =  agent.getAuctionFor(TACAgent.CAT_HOTEL,
					  TACAgent.TYPE_GOOD_HOTEL, i-7);

		  }
		  else if(i<16){
			  information[i] =  agent.getAuctionFor(TACAgent.CAT_HOTEL,
					  TACAgent.TYPE_CHEAP_HOTEL, i-11);
		  }
		  else if(i<20){
